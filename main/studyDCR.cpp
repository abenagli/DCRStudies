...
int main(int argc, char** argv)
{
  ...
  for(unsigned int ii = 0; ii < thrs_nPhE.size(); ++ii)
  {
    ...
    h1_timeLE_baseSub[thr_nPhE] = new TH1F(Form("h1_timeLE_baseSub_thr%04dPhE",thr_nPhE),"",int(overSampling*(xMax-xMin)/xBinWidth),xMin,xMax);
    h1_timeLE_CFD[thr_nPhE]     = new TH1F(Form(    "h1_timeLE_CFD_thr%04dPhE",thr_nPhE),"",int(overSampling*(xMax-xMin)/xBinWidth),xMin,xMax);
  }
